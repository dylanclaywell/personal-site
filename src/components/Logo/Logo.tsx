...
export default function Logo() {
  return (
    <div>
      <div className="px-8 py-16 relative w-fit">
        ...
        <Typography
          isNeon
          component="h1"
          className="absolute text-[8rem] font-[Yellowtail] top-1/2 left-1/2 -translate-x-1/2 -translate-y-3/4 before:absolute before:top-0 before:left-0 whitespace-nowrap"
        >
          Dylan Claywell
        </Typography>
      </div>
